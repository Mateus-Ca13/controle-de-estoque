...
function Footer() {
    ...
    return (
        <section className="w-full dark:bg-neutral-800 p-8 shadow-lg rounded-md bg-white flex flex-col items-center justify-center dark:text-neutral-300 text-neutral-600 gap-2">
            ...
            <p className="flex  font-semibold text-sm  text-center"><PiCopyright className="me-0.5 text-xl"/> 2025 Controle de Estoque - Todos os direitos reservados.</p>
        </section>
    )
}
